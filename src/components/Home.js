...
const Home = () => {
    return (
        <div className="ContainerPrincipal">
            ...
            <p className="parrafoInicio">Leer es algo que disfruto mucho, por ello, es importante para mí llevar un registro de los autores que he leído y sus respectivos libros.</p>
